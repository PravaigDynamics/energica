    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-zinc-200 mb-2">Welcome Back</h1>
          <p className="text-zinc-400">Sign in to your Energica account</p>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center gap-2 px-4 py-3 bg-black border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors disabled:opacity-50"
              >
                <GoogleIcon />
              ...
              >
                ...
                <span className="text-zinc-200">Facebook</span>
              </button>
            </div>
          </div>
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link to="/register" className="text-lime-500 hover:text-lime-400 transition-colors">
              Sign up
            </Link>
          </div>
        </div>
